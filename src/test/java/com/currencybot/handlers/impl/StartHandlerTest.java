...
class StartHandlerTest {
    ...
    public void handleTest(){
        ...
        List<PartialBotApiMethod<? extends Serializable>> handle = startHandler.handle(user,"");
    ...
    public void operatedBotStateTest(){
        ...
        BotState returnBotState = startHandler.operatedBotState();
    ...
    public void operatedCallbackQueryTest(){
        List<String> operatedCallbackQueries = List.of(ConfigStrings.BACK);
        List<String> returnedOperatedCallbackQueries = startHandler.operatedCallBackQuery();
